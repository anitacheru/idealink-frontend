    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          >
            Join IdeaLink and start connecting today
          </motion.p>
        </div>
          ...
          <form onSubmit={submit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <p className={`text-sm font-semibold ${
                    form.role === "idea-generator" ? "text-[#4ca1af]" : "text-gray-400"
                  }`}>
                    Idea Generator
                  </p>
                </motion.button>
                ...
                <motion.button
                  ...
                  className={`p-4 rounded-lg border-2 transition-all ${
                    form.role === "investor"
                      ? "border-[#2c3e50] bg-[#2c3e50]/10"
                      : "border-gray-700 hover:border-gray-600"
                  }`}
                >
                  <div className="text-3xl mb-2">📈</div>
                  <p className={`text-sm font-semibold ${
                    form.role === "investor" ? "text-[#2c3e50]" : "text-gray-400"
                  }`}>
                    Investor
                  </p>
                </motion.button>
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                required
                className="w-4 h-4 mt-1 text-[#4ca1af] bg-black border-gray-700 rounded focus:ring-[#4ca1af]"
              />
